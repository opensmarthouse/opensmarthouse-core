...
In this section you will be guided through developing *Module Types* and corresponding *Module Handlers* for the automation engine of _OpenSmartHouse_.
...
The automation engine reads rule json files from the `{opensmarthouse-dir}/automation/*.json` directory.
