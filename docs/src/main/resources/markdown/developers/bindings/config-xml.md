...
The full XML schema for configuration descriptions is specified in the [OpenSmartHouse config description XSD](https://opensmarthouse.org/schemas/config-description-1.0.0.xsd) file.
