 ...
 */
package org.opensmarthouse.core;
...
/**
 * Some core static methods that provide information about the running OpenSmartHouse instance.
 *
...
public class OpenSmartHouse {
    ...
    public static String getVersion() {
        String versionString = FrameworkUtil.getBundle(OpenSmartHouse.class).getVersion().toString();
