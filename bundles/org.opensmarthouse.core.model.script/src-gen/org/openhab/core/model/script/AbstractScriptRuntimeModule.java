...
import org.openhab.core.model.script.parser.antlr.ScriptAntlrTokenFileProvider;
import org.openhab.core.model.script.parser.antlr.ScriptParser;
import org.openhab.core.model.script.parser.antlr.internal.InternalScriptLexer;
...
import org.openhab.core.model.script.serializer.ScriptSyntacticSequencer;
...
public abstract class AbstractScriptRuntimeModule extends DefaultXbaseRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/openhab/core/model/script/Script.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.openhab.core.model.script.Script");
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalScriptLexer> provideInternalScriptLexer() {
