...
@NonNullByDefault
public class ConfigI18nLocalizationServiceImpl implements ConfigI18nLocalizationService {
    ...
    @Activate
    public ConfigI18nLocalizationServiceImpl(final @Reference TranslationProvider i18nProvider) {
