...
/**
 * {@link CoreItemChannelLinkRegistry} tracks all {@link ItemChannelLinkProvider}s
 ...
 * @author Łukasz Dywicki - Separated class and interface {@link ItemChannelLinkRegistry}.
 */
@NonNullByDefault
@Component(immediate = true, service = ItemChannelLinkRegistry.class)
public class CoreItemChannelLinkRegistry extends AbstractLinkRegistry<ItemChannelLink, ItemChannelLinkProvider> implements
    ...
    @Activate
    public CoreItemChannelLinkRegistry(final @Reference ThingRegistry thingRegistry,
