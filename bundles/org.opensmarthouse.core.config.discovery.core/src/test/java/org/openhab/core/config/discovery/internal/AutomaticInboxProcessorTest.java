...
public class AutomaticInboxProcessorTest {
    ...
    public void testThingWithOtherBindingIDButSameRepresentationPropertyWentOnline() {
        ...
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID).withProperty(DEVICE_ID_KEY, DEVICE_ID)
                .withRepresentationProperty(DEVICE_ID_KEY).build());
    ...
    public void testThingWithOtherBindingIDButSameRepresentationPropertyIsDiscovered() {
        ...
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID3).withProperty(DEVICE_ID_KEY, DEVICE_ID)
                .withRepresentationProperty(DEVICE_ID_KEY).build());
    ...
    public void testThingWhenNoRepresentationPropertySet() {
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID).withProperty(DEVICE_ID_KEY, DEVICE_ID).build());
        List<DiscoveryResult> results = inbox.stream().filter(withFlag(DiscoveryResultFlag.NEW))
                .collect(Collectors.toList());
        assertThat(results.size(), is(1));
        assertThat(results.get(0).getThingUID(), is(equalTo(THING_UID)));
    ...
    public void testInboxHasBeenChanged() {
        ...
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID2).withProperty(DEVICE_ID_KEY, DEVICE_ID)
                .withRepresentationProperty(DEVICE_ID_KEY).build());
    ...
    public void testThingWithConfigWentOnline() {
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID2).withProperty(OTHER_KEY, OTHER_VALUE)
                .withRepresentationProperty(OTHER_KEY).build());
    ...
    public void testInboxWithConfigHasBeenChanged() {
        ...
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID).withProperty(OTHER_KEY, OTHER_VALUE)
                .withRepresentationProperty(OTHER_KEY).build());
    ...
    public void testAutomaticDiscoveryResultApprovalIfInboxEntriesAddedAfterApprovalPredicatesAreAdded() {
        ...
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID).build());
        ...
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID3).build());
    ...
    public void testAutomaticDiscoveryResultApprovalIfInboxEntriesExistBeforeApprovalPredicatesAreAdded() {
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID).build());
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID2).build());
        inbox.add(new DiscoveryResultBuilderFactoryImpl().create(THING_UID3).build());
