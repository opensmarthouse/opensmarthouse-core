...
public class BundledSoundFileHandler implements Closeable {
    ...
    public BundledSoundFileHandler() throws IOException {
        ...
        System.setProperty(OpenSmartHouse.CONFIG_DIR_PROG_ARGUMENT, configdir.toString());
    ...
    @Override
    public void close() {
        System.setProperty(OpenSmartHouse.CONFIG_DIR_PROG_ARGUMENT, OpenSmartHouse.DEFAULT_CONFIG_FOLDER);
