...
/**
 * This filter is responsible for parsing credentials provided with a request,
 * and hydrating a {@link SecurityContext} from these credentials if they are
 * valid.
 *
...
public class AuthFilter implements ContainerRequestFilter {
    ...
    private @Nullable String getCacheKey(String credentials) {
        ...
        try {
            ...
            // SHA-256 is available for all java distributions so this code will actually
            // never run
