...
import org.openhab.core.internal.types.registry.TypeRegistryImpl;
...
import org.openhab.core.library.types.internal.CoreTypeProvider;
...
class ExpireManagerTest {
    ...
    public void setup() {
        ...
        registry.addTypeProvider(new CoreTypeProvider());
        registry.addTypeProvider(new BaseTypeProvider());
        new TypeParser().setTypeProvider(registry);
    }
