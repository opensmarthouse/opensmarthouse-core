...
public class ThreadFactoryBuilderTest {
    ...
    public void testWithDefaultNamePrefix() {
        ...
        assertThat(threadFactory.newThread(TEST_RUNNABLE).getName(), is("OSH-hello-1"));
        assertThat(threadFactory.newThread(TEST_RUNNABLE).getName(), is("OSH-hello-2"));
        assertThat(threadFactory.newThread(TEST_RUNNABLE).getName(), is("OSH-hello-3"));
    }
    ...
    public void testWithWrappedThreadFactory() {
        ...
        assertThat(testThread.getName(), is("OSH-" + testThreadName));
    }
}
