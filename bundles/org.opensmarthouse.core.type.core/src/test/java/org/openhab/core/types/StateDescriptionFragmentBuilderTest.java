...
/**
 * Test the {@link CoreStateDescriptionFragmentBuilder}.
 *
...
public class StateDescriptionFragmentBuilderTest {
    ...
    @Before
    public void setup() {
        builder = CoreStateDescriptionFragmentBuilder.create();
    }
    ...
    public void builderWithStateDescription() {
        ...
        StateDescriptionFragmentBuilder builder = CoreStateDescriptionFragmentBuilder.create(source);
