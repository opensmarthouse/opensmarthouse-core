...
import org.openhab.core.thing.internal.builder.BridgeBuilderImpl;
...
public class ThingBuilderFactoryImpl implements ThingBuilderFactory {

    @Override
    public ThingBuilder createThing(ThingTypeUID thingTypeUID, ThingUID uid) {
        return ThingBuilderImpl.create(thingTypeUID, uid);
    }

    @Override
    public BridgeBuilder createBridge(ThingTypeUID thingTypeUID, ThingUID uid) {
        return BridgeBuilderImpl.create(thingTypeUID, uid);
    }
}
