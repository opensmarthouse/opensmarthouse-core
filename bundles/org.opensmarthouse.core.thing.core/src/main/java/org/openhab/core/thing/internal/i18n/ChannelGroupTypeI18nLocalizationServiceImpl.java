...
/**
 * Default implementation of {@link ChannelGroupTypeI18nLocalizationService}.
 *
 * @author Łukasz Dywicki - Initial contribution.
 */
@Component(service = ChannelGroupTypeI18nLocalizationService.class)
@NonNullByDefault
public class ChannelGroupTypeI18nLocalizationServiceImpl implements ChannelGroupTypeI18nLocalizationService {

    private final ThingTypeI18nUtil thingTypeI18nUtil;
    private final ChannelI18nUtil channelI18nUtil;

    @Activate
    public ChannelGroupTypeI18nLocalizationServiceImpl(final @Reference TranslationProvider i18nProvider,
