...
public class ThingManagerImplTest {
    ...
    private @Mock @NonNullByDefault({}) ChannelBuilderFactory channelBuilderFactory;
    ...
    private @Mock @NonNullByDefault({}) ThingStatusInfoI18nLocalizationService thingStatusInfoI18nLocalizationService;
    ...
    private ThingManagerImpl createThingManager() {
        return new ThingManagerImpl(bundleResolverMock, channelBuilderFactory, channelGroupTypeRegistryMock, channelTypeRegistryMock,
    ...
    public void thingHandlerFactoryLifecycle() {
        ...
        thingManager.thingAdded(thingMock, ThingTracker.ThingTrackerEvent.THING_ADDED);
